...
export function GeneralSection() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionHeader
        title="Overview"
        description="Workspace behavior, editor ergonomics, terminal rendering, startup, and notification controls."
      />
        ...
        <div className="grid grid-cols-3 gap-2">
          {APPEARANCE.map((o) => (
            <button
              ...
              className={cn(
                "clack-settings-card group flex h-20 flex-col items-center justify-center gap-1.5 transition-all",
                mode === o.id
      ...
      <div className="flex flex-col gap-2">
        <Label>Zoom</Label>
        <div className="clack-settings-card flex flex-col gap-3 p-3">
      ...
      <div className="flex flex-col gap-2">
        ...
        <SettingRow
          ...
          description="Alert when Claude Code or Codex running in a terminal needs your input or finishes. Desktop notification when Clack is unfocused, in-app otherwise."
        >
          <Switch
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          <SettingRow
            ...
            description="Open Clack automatically when you sign in."
          >
            <Switch
              checked={autostart}
