...
export function ThemesSection() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <SectionHeader
        title="Appearance"
        description="Clack themes, editor syntax colors, and local background images."
      />

      <fieldset
        aria-label="Theme import drop zone"
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <input
            ref={fileInputRef}
            type="file"
            accept=".clack-theme,.terax-theme,.json,application/json"
            className="hidden"
            onChange={(e) => {
          ...
          {themes.map((t) => {
            ...
            return (
              <div
                key={t.id}
                className={cn(
                  "group flex items-center gap-2 rounded-lg border p-2.5 transition-all",
                  selected
              ...
              >
                <button
                  ...
                  className="flex min-w-0 flex-1 items-center gap-3 rounded-md text-left outline-none focus-visible:ring-2 focus-visible:ring-ring/45"
                >
                <div
                ...
                {isCustom ? (
                  <div className="ml-1 flex shrink-0 items-center gap-0.5 opacity-0 transition group-focus-within:opacity-100 group-hover:opacity-100">
                    <button
                      type="button"
      ...
      <fieldset
        aria-label="Background image drop zone"
        className="m-0 flex min-w-0 flex-col gap-2 border-0 p-0"
        onDragOver={(e) => {
          e.preventDefault();
          e.dataTransfer.dropEffect = "copy";
