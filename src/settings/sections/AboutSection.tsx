...
export function AboutSection() {
  ...
  const [name, setName] = useState("Clack");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-4 rounded-xl border border-border/60 bg-card/60 p-5">
        ...
        <div className="flex min-w-0 flex-col">
          ...
          <span className="text-[11px] text-muted-foreground">
            AI-native IDE and agent workspace
          </span>
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">app.clack.dev</dd>
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-[11px] text-muted-foreground">
          Automatic updates need a Clack release channel and signing key before
          they can be enabled.
        </p>
      </div>
    </div>
