...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      "group-[.is-user]:rounded-[var(--clack-radius-panel)] group-[.is-user]:border group-[.is-user]:border-[color:var(--clack-border-accent)] group-[.is-user]:bg-[var(--clack-accent-soft)] group-[.is-user]:px-3 group-[.is-user]:py-2 group-[.is-user]:text-[var(--clack-text-1)]",
      "group-[.is-assistant]:w-full group-[.is-assistant]:max-w-full group-[.is-assistant]:text-[var(--clack-text-1)]",
      className,
    )}
    {...props}
  >
