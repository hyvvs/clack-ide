      ...
      <div className="flex w-max items-center gap-0.5">
        ...
        >
          ...
          >
            <span
              aria-hidden
              className="pointer-events-none absolute left-0 top-1/2 h-7 rounded-[var(--clack-radius-button)] border border-[color:var(--clack-border-accent)] bg-[var(--clack-accent-soft)] shadow-[inset_0_-1px_0_rgba(125,183,255,0.28)]"
              style={
                pill
                  ? {
                      width: pill.width,
            ...
            {tabs.map((t) => {
              ...
              const trigger = (
                <TabsTrigger
                  ...
                  className={cn(
                    "clack-tab group relative z-[1] h-7 shrink-0 justify-between gap-1.5 bg-transparent text-xs transition-colors data-active:bg-transparent dark:data-active:bg-transparent",
                    isNew && "clack-tab-in",
                    isActive
                      ? "text-[var(--clack-text-1)] dark:text-[var(--clack-text-1)]"
                      : "text-[var(--clack-text-3)] dark:text-[var(--clack-text-3)]",
                    compact
                      ? "px-1.5!"
                      : tabs.length === 1
                        ? "px-2!"
